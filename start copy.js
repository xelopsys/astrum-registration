...
//     await ctx.reply('please send me ur contact', {
//         reply_markup: {
//             keyboard: [
...
// getLang.on('contact', async (ctx) => {
//     if (ctx.session.lang === 'рус') {
//         await ctx.replyWithHTML('thank u рус')
//     }
//     if (ctx.session.lang === 'UZB') {
//         await ctx.replyWithHTML('thank u uzb')
//     }
//     if (ctx.session.lang === 'ENG') {
//         await ctx.replyWithHTML('thank u ENG')
//     }
// })
